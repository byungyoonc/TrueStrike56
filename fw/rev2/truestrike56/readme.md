...
TrueStrike56 is a columnar staggered unibody split Hall effect keyboard designed to maximize performance and minimize finger fatigue.
...
* Hardware Availability: https://github.com/byungyoonc/TrueStrike56

Make example for this keyboard (after setting up your build environment):

    make truestrike56:default

Flashing example for this keyboard:

    make truestrike56:default:flash
